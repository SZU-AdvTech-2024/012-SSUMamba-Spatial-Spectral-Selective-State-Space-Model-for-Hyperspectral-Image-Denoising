...
from mamba.models.mambairv2light_arch import MambaIRv2Light

sys.path.append('/data/liuliyuan/Code/SSUMamba-main')
...
if __name__ == '__main__':
    ...
    # summary(model, (1,31,64,64))

    # with SummaryWriter(comment='SSUMamba') as w:
    #     w.add_graph(model, torch.rand(1,31,64,64)) 
    print(model)

    # modelData = "/data/liuliyuan/Code/SSUMamba-main/checkpoints_ssumamba_sscs/ssumamba_sscs_95.ckpt"  # 定义模型数据保存的路径
