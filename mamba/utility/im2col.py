...
def Im2Col(input_tensor, kernel_size, stride, padding,dilation=1,tensorized=False,):
    ...
    return out
def Cube2Col(input_tensor, kernel_size, stride, padding,dilation=1,tensorized=False,device = torch.device("cuda:6" if torch.cuda.is_available() else "cpu")):
...
def Col2Cube(input_tensor,output_size, kernel_size, stride, padding, dilation=1, avg=False,input_tensorized=False,device = torch.device("cuda:6" if torch.cuda.is_available() else "cpu")):
    batch = input_tensor.shape[0]
